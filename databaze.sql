...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2021 at 05:20 PM
...
CREATE TABLE `majitel_vozu` (
  `idmajitel_vozu` int(11) NOT NULL,
...
INSERT INTO `majitel_vozu` (`idmajitel_vozu`, `jmeno`, `prijmeni`, `adresa`, `telefon`, `email`) VALUES
(1, 'Stepan', 'Zboril', 'Straznicka 1272, 696 42', '777 777 777', 'stepan.vracov@gmail.com'),
...
(1, '127.0.0.1', 'administrator', '$2y$12$QdcCWH15E/G7kP3GNVG0GeFwTsdlQnOw9QJqJyYOupoly7duO3Jeq', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1616780859, 1, 'Admin', 'istrator', 'ADMIN', '0'),
...
INSERT INTO `zamestnanci` (`idzaměstnanci`, `jmeno`, `prijmeni`, `osobni_cislo`) VALUES
(1, 'Jan', 'Novák', 1),
(2, 'Tereza', 'Novotná', 2),
(3, 'Nikolas', 'Tuzil', 3),
(4, 'Nikola', 'Niklová', 4),
...
ALTER TABLE `majitel_vozu`
  ADD PRIMARY KEY (`idmajitel_vozu`);
...
--
ALTER TABLE `majitel_vozu`
  MODIFY `idmajitel_vozu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `zamestnanci`
  MODIFY `idzaměstnanci` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
